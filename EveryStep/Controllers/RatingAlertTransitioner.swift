//
//  RatingAlertTransitioner.swift
//  Newsy
//
//  Created by Stuart Buchbinder on 11/20/15.
...
class RatingAlertTransitioner: NSObject, UIViewControllerTransitioningDelegate {

    func presentationControllerForPresentedViewController(presented: UIViewController, presentingViewController presenting: UIViewController, sourceViewController source: UIViewController) -> UIPresentationController? {
        return RatingPresentationController(presentedViewController: presented, presentingViewController: presenting)
    }
}

class RatingPresentationController : UIPresentationController {
...
extension RatingAlertTransitioner {
...
extension RatingAlertTransitioner : UIViewControllerAnimatedTransitioning {
